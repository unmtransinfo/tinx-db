...
FROM
  do_parent p1
  LEFT JOIN do_parent p2 ON p2.doid = p1.parent_id
  LEFT JOIN do_parent p3 ON p3.doid = p2.parent_id
  LEFT JOIN do_parent p4 ON p4.doid = p3.parent_id
  LEFT JOIN do_parent p5 ON p5.doid = p4.parent_id
  LEFT JOIN do_parent p6 ON p6.doid = p5.parent_id
  LEFT JOIN do_parent p7 ON p7.doid = p6.parent_id
  LEFT JOIN do_parent p8 ON p8.doid = p7.parent_id
  LEFT JOIN do_parent p9 ON p9.doid = p8.parent_id
  LEFT JOIN do_parent p10 ON p10.doid = p9.parent_id
  LEFT JOIN do_parent p11 ON p11.doid = p10.parent_id
  LEFT JOIN do_parent p12 ON p12.doid = p11.parent_id
  LEFT JOIN do_parent p13 ON p13.doid = p12.parent_id
  LEFT JOIN do_parent p14 ON p14.doid = p13.parent_id;
